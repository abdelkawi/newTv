...
interface Repository {
  suspend fun login(userEmail: String, password: String): Response<LoginBean>
  ...
  suspend fun changeLang(lang: String): Response<ChangeLangResponse>
  ...
  suspend fun listing(type: String, isNewRelease: Boolean): Response<ListingResponse>
